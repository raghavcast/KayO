...
#define BT_USART_TX_GPIO_Port GPIOA
#define BT_USART_RX_Pin GPIO_PIN_3
#define BT_USART_RX_GPIO_Port GPIOA
#define BT_Mode0_Pin GPIO_PIN_4
#define BT_Mode0_GPIO_Port GPIOA
#define BT_Mode1_Pin GPIO_PIN_5
#define BT_Mode1_GPIO_Port GPIOA
#define BT_Mode2_Pin GPIO_PIN_6
#define BT_Mode2_GPIO_Port GPIOA
#define BT_Mode3_Pin GPIO_PIN_7
#define BT_Mode3_GPIO_Port GPIOA
...
#define Battery_EN1_Pin GPIO_PIN_6
#define Battery_EN1_GPIO_Port GPIOC
#define BatteryEN2_Pin GPIO_PIN_7
#define BatteryEN2_GPIO_Port GPIOC
#define Battery_GPOUT_Pin GPIO_PIN_8
#define Battery_GPOUT_GPIO_Port GPIOC
#define Battery_I2C_SDA_Pin GPIO_PIN_9
#define Battery_I2C_SDA_GPIO_Port GPIOC
#define Battery_I2C_SCL_Pin GPIO_PIN_8
#define Battery_I2C_SCL_GPIO_Port GPIOA
#define Battery_TMR_Pin GPIO_PIN_9
#define Battery_TMR_GPIO_Port GPIOA
#define Battery_CE_Pin GPIO_PIN_10
#define Battery_CE_GPIO_Port GPIOA
