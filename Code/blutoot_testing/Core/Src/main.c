...
uint8_t * doll = (uint8_t *)"$$$";
uint8_t * end_mes = (uint8_t *)"---\r";
/* USER CODE END 0 */
...
//	  HAL_UART_Transmit(&huart1, doll, sizeof(doll), HAL_MAX_DELAY);
//	  HAL_UART_Transmit(&huart2, doll, sizeof(doll), HAL_MAX_DELAY);
//	  HAL_Delay(2000);
