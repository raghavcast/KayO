...
{
	return TSC2046_SendCommand(CMD_X_AXIS );
}
//ii. get y-axis raw touch 12-bit value
uint16_t TSC2046_getRaw_Y(void)
{
	return TSC2046_SendCommand(CMD_Y_AXIS );
}
...
{
	ILI9341_DrawFilledCircle(10, 10, 3, ILI9341_RED);
//	ILI9341_printText("Press here", 20, 30, COLOR_RED, COLOR_RED, 1);
}
//ii. Bottom-Right corner point
void TSC2046_BR_point(void)
{
	ILI9341_DrawFilledCircle(myTS_Calibrate.Width-10, myTS_Calibrate.Height-10, 3, ILI9341_RED);
